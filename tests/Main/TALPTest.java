...
public class TALPTest {
	...
	public void assignmentTest() {
		...
		System.out.println("Objective Value Expected: 3 | Actual : " + val);
		assertTrue(val == 3);
		System.out.println("--------------------------------------------------------------------");
		System.out.println();
		
		System.out.println("-------------------Assignment Test-----------------------------");
		val = GLPK.glp_get_col_prim(lp.getProblem(), 1);
		System.out.println("TA1COURSE1 EXPECTED VALUE = 1.0 | ACTUAL VALUE = " + val);
		assertTrue(val == 1);
		
		val = GLPK.glp_get_col_prim(lp.getProblem(), 6);
		System.out.println("TA2COURSE3 EXPECTED VALUE = 1.0 | ACTUAL VALUE = " + val);
		assertTrue(val == 1);
		
		val = GLPK.glp_get_col_prim(lp.getProblem(), 8);
		System.out.println("TA3COURSE2 EXPECTED VALUE = 1.0 | ACTUAL VALUE = " + val);
		assertTrue(val == 1);
		System.out.println("----------------------------------------------------------------");
	}
}
